...
export default function Page({ params }) {
    ...
    function extractAfterFirstDash(input) {
      ...
      extractAfterFirstDash(sitelink);
    ...
    return (
        <div className="relative overflow-y-auto">
            ...
            <main>
               ...
               {extractAfterFirstDash(sitelink) == 'cost' &&  <PlanInfolp3 isMeta={isMeta} />}
               {extractAfterFirstDash(sitelink) == 'specialist' && <SpeciaListslp3 service={service} isMeta={isMeta} />}
               {extractAfterFirstDash(sitelink) == 'stories' && <section className="max-w-screen-4xl mx-auto px-4 lg:px-10 xl:px-14 2xl:px-20 py-10 lg:py-16 bg-[url(/images/lp/campaign/treatment_bg_img_cropped.png)] bg-repeat relative">
                ...
                {extractAfterFirstDash(sitelink) == 'trustedclinic' && <IVFClinicSliderlp3 center={filteredCity} cityVideos={cityVideos} service={service} />}
