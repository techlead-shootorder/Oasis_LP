...
interface IVFClinicSliderV2Props {
    center: any;
...
export default function IVFClinicSliderV2({ center, userAgentString, cityVideos, service }: IVFClinicSliderV2Props) {
    ...
    const [ivfClinicsList, setIvfClinicsList] = useState<any>(cityVideos);
            ...
            <div className="pb-16 lg:pb-16 mb-6 relative">
                ...
                >
                    {ivfClinicsList?.map((video: any, index: number) => {
                        return <div ref={currentVideoRef} key={video?.VideoTitleText}>
                            {((video.isSelected == false)) ? 
                                ...
                                <div className="aspect-[9/16]">
                                    <YouTube 
                                        ...
                                        onPlay={(event: any) => { setYoutubeEvent(event?.target) }} 
                                        onPause={(event: any) => { event?.target?.pauseVideo() }} 
                                    />
                                </div>
                            }
                        </div>
