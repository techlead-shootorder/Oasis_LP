...
const TrustedClinic = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 bg-[url(/images/lp/campaign/treatment_bg_img_cropped.png)] bg-repeat py-10 px-4 rounded-2xl">
      <div className="w-full lg:w-[30%] text-center lg:text-left">
        <h2 className="text-[22px] md:text-2xl lg:text-3xl xl:text-5xl 2xl:text-[52px] font-bold leading-tight text-primary text-center tracking-wide">
          Most Trusted IVF Clinic in Hyderabad
